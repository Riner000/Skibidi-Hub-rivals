-- ============================================================
-- SKIBIDI HUB RIVALS v2.0 (FIXED - NO CONTINUE)
-- PHẦN 1/5: KHỞI TẠO + SETTINGS + UTILITY
-- ============================================================
    ...
    if enabled then
        ...
        pcall(function()
            ...
            for effect, state in pairs(FPSBoostState.Effects) do
                if effect and effect.Enabled ~= nil then effect.Enabled = state end
            end
    ...
    for _, player in pairs(GetAlivePlayers()) do
        if player.Character then
            if Settings.AIM.TeamCheck and player.Team == LocalPlayer.Team then
                -- bỏ qua
            elseif Settings.AIM.VisibleCheck and not IsPlayerVisible(player) then
                -- bỏ qua
            else
